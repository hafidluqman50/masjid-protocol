...
type Masjid struct {
	...
	MasjidID         string     `gorm:"uniqueIndex;column:masjid_id;not null" json:"masjid_id"`
	...
	CashOutThreshold int64      `gorm:"column:cash_out_threshold;default:0" json:"cash_out_threshold"`
